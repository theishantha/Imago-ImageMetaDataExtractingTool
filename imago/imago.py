...
##################################################	
	...
	parser.add_argument('-t','--type', help='Select the image, this flag can be JPEG, if this argument it is not provided, imago will process all the image types', type=str, choices=["jpeg"])
	args = parser.parse_args()

	if (args.exif or args.gps or args.ela or args.digest or args.percentualhash):
